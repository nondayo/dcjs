...
// const a = outOfDateQuantityByCategory.all()
// console.log(a);
// [{
//     key: "fruit",
//     value: 10
...
// {fruit: 2.1, vegetable: 2.5}
// 21/10, 25/2


// let all = supermarketItems.dimension(item => "total")
//     .group()
//     .reduceSum(item => item.outOfDateQuantity)
//     .all()
// console.log("all:");
// console.log(all);
...
//     let ratio = {}
//     ratio.key = item.key
//     // ratio.value = quantityByCategory.all()[index].value / item.value //(21/10, 25/2)
//     // ratio.value = outOfDateQuantityByCategory.all()[index].value / item.value //(10/10, 2/2)
//     ratio.value = 100 * item.value / all[0].value
